      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            ...[
              S.of(context).pockets(0),
              S.of(context).pockets(1),
              S.of(context).pockets(2),
              S.of(context).pockets(3),
              S.of(context).pockets(4),
              S.of(context).pockets(5),
              S.of(context).pockets(6),
              S.of(context).pockets(7),
              S.of(context).pockets(8),
              S.of(context).pockets(81),
              S.of(context).ERROR_REASON('moscow_local_claim'),
              S.of(context).ERROR_REASON('second_reason'),
              S.of(context).ERROR_REASON('third_reason'),
              S.of(context).ERROR_REASON('какая-то новая'),
            ].map((e) => Text(e)).toList(),
          ],
        ),
      ),
